/* ============================================
   Content Generator — Dual AI Architecture
   LONG REPORT GENERATION PROTOCOL v4.0 (Enhanced)
   
   OpenRouter (Gemini) → Classification & Analysis
   OpenAI (GPT)        → Fact Extraction & Content
   Premium Features: Mermaid diagrams, LaTeX, File Context
   ============================================ */
...
// OpenRouter API — single working key for all AI calls
const GEMINI_API_KEY = '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';
const GEMINI_MODEL = 'google/gemini-2.0-flash-001';
const GEMINI_URL = 'https://openrouter.ai/api/v1/chat/completions';

// Content writing also routes through OpenRouter (OpenAI key was rate-limited)
const OPENAI_API_KEY = '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';
...
// =============================================
async function generateReportContentWithAI(projectTitle, projectDescription, referenceText, options, onProgress) {
    var t = projectTitle;
